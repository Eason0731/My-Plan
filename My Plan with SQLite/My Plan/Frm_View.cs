...
namespace My_Plan
{
    public partial class Frm_View : Form
    {
        ...
        string Conn = "data source = MyData.db";
        ...
        private void btn_select_Click(object sender, EventArgs e)
        {
            ...
            SQLiteConnection myCon = new SQLiteConnection(Conn); //连接到数据库
            ...
            SQLiteDataAdapter myAda = new SQLiteDataAdapter(myStr1, myCon); //在连接好的数据库中打开已连接的表
        ...
        private void btn_del_Click(object sender, EventArgs e)
        {
            ...
            if (dr == DialogResult.OK)//如果点击“确定”按钮
            {
                for (int i = 0; i < dataGridView1.SelectedRows.Count; i++)
                {
                    ...
                    SQLiteCommand myCmd = new SQLiteCommand(delStr, myCon);
